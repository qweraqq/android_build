...
echo "ro.build.display.id=QKQ1.190828.002"
...
echo "ro.build.date=Fri Jun 25 16:13:31 CST 2021"
echo "ro.build.date.utc=1624608811"
echo "ro.build.type=user"
echo "ro.build.user=builder"
echo "ro.build.host=c4-miui-ota-bd110.bj"
echo "ro.build.tags=release-keys"
echo "ro.build.flavor=sirius-user"
